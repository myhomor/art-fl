...
class Users extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('PERSONAL_NAME, PERSONAL_LASTNAME, PASSWORD, EMAIL, ID_COUNTRY, ID_CITY, ID_CURRENCY, ID_LANG', 'required'),
			array('EMAIL', 'unique'),
			array('EMAIL', 'email', 'on'=>self::FLAG_REGISTER),
			array('EMAIL', 'length', 'min'=>6, 'max'=>50),
			array('EMAIL', 'filter', 'filter'=>'mb_strtolower'),
			
			//array('LOGIN, PASSWORD, U_CSUMM, EMAIL, PERSONAL_AVATAR, PERSONAL_NAME, PERSONAL_LASTNAME, PERSONAL_COMPANY, PERSONAL_STATUS, PERSONAL_BDAY, PERSONAL_ABOUT_TEX, LAST_LOGIN, DATE_REGISTER, ID_CONTACT, ID_COUNTRY, ID_CITY, ID_PROFILE_FLANCE, ID_PROFILE_CUSTOMER, ID_PROFILE_ACTIVE, ID_CURRENCY, ID_LANG, FREND_LIST, ID_STATUS, ID_ROLE', 'required'),
			...
			array('PERSONAL_NAME, PERSONAL_LASTNAME, PERSONAL_COMPANY', 'length', 'max'=>250),
			array('PERSONAL_STATUS', 'length', 'max'=>150),

...
class Profile extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('PERSONAL_AVATAR, PERSONAL_ABOUT_TEX, ID_USER_TAGS, CONTACT_PHONE, CONTACT_MAIL, CONTACT_ICQ, CONTACT_SITE', 'required', 'on' => self::FLAG_REGISTER),
			
			//array('ID_REVIEW, PERSONAL_PHOTO, PERSONAL_AVATAR, PERSONAL_ABOUT_TEX, ID_USER_PORTFOLIO, ID_USER_PROJECTS_ARCHIVE, ID_USER_PROJECTS_ACTIVE, ID_USER_TAGS, PERSONAL_SOUL_MINUS, PERSONAL_SOUL_PLUS, PERSONAL_FINAL_PROJECT, CONTACT_PHONE, CONTACT_MAIL, CONTACT_ICQ, CONTACT_SITE', 'required'),
			
			//array('PERSONAL_AVATAR', 'file', 'types'=>'jpg,jpeg,gif,png', 'allowEmpty'=>true, 'on' => self::FLAG_REGISTER),
			
			array('PERSONAL_AVATAR, ID_USER_PROJECTS_ARCHIVE, ID_USER_PROJECTS_ACTIVE, PERSONAL_SOUL_MINUS, PERSONAL_SOUL_PLUS, PERSONAL_FINAL_PROJECT, CONTACT_ICQ', 'numerical', 'integerOnly'=>true),
			
			array('ID_USER_TAGS,type_profile', 'required', 'on' => self::FLAG_REGISTER),
			
			array('PERSONAL_ABOUT_TEX, CONTACT_SITE', 'length', 'max'=>256),
			array('CONTACT_PHONE', 'length', 'max'=>20),
			array('CONTACT_MAIL', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID, ID_REVIEW, PERSONAL_PHOTO, PERSONAL_ABOUT_TEX, ID_USER_PORTFOLIO, ID_USER_PROJECTS_ARCHIVE, ID_USER_PROJECTS_ACTIVE, ID_USER_TAGS, PERSONAL_SOUL_MINUS, PERSONAL_SOUL_PLUS, PERSONAL_FINAL_PROJECT, CONTACT_PHONE, CONTACT_MAIL, CONTACT_ICQ, CONTACT_SITE', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('CONTACT_ICQ',$this->CONTACT_ICQ);
